...
class Login extends REST_Controller {
  ...
  private function register_create( ) {
      $user = $this->from_json( $this->contents, array( 'name', 'email', 'encryptedpassword' ) );
      ...
      unset ( $user['password'] );
      $user['id'] = $user['name'];
      echo $this->to_json( $user, array( 'name', 'email', 'id' ) );
  }
  
  private function login_update( $id ) {
      $user = $this->from_json( $this->contents, array( 'name', 'encryptedpassword' ) );
      ...
      echo $this->to_json( $user, array( 'name', 'email', 'id', 'logged' ) );
  }
