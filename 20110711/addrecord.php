...
<td>Количество</td><td>Мин.</td><td>Коп.</td><td>Заказ</td><td>Н/ч</td><td>Грн.</td><td>Действие</td></tr>
EOS
;//'
...
while ($result and $row = pg_fetch_array($result)) {
    ...
    ." onclick=\'delete_line(this,{$row['god']},{$row['mes']},{$row['nar']},{$row['npp']} )\'>Удалить</div></td>";
...
<td>\&nbsp;</td><td>\&nbsp;</td><td>\&nbsp;</td><td>\&nbsp;</td><td><b>$my_tr</b> Н/ч</td><td><b>$my_zp</b> Грн.</td><td>\&nbsp;</td></tr>
EOS
;//'
