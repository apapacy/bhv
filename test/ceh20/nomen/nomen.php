...
<head>
<title>Информация по детали (сб.ед.)</title>
<style type="text/css">
body{
...
Деталь(сб.ед.): <span id=combo1 style="width:300px"></span> 
<!--input type=button name="name_button_show_kod" id="id_button_show_kod" value="Показать состав сборочной единицы" onclick="f_show_kod(this);" /-->
<!--input type=checkbox name="name_checkbox_show_kod" id="id_checkbox_show_kod" onclick="f_show_kod(this)"> Сокращенный вид>
...
<br>Материал <span id=combo3 style="width:300px"></span>
<input type=button name="add_mat_name" id="id_add_mat_name" value="Добавить новый" onclick="f_add_mat(this);" /><input type=text name="name_input_mat_name" id="id_input_mat_name" value=""/>
...
<br /><input type=button name=name_save_nomen_kod id=id_save_nomen_kod onclick="f_save_nomen_kod(this)" value="Сохранить изменения">

<br /><span id=combo2 style="width:300px"></span>
<!--input type=button name="name_button_show_kod" id="id_button_show_kod" value="Показать журнал изменений" onclick="f_show_izm(this);" /-->
<br />Коэффициент<input type=text name="name_input_nomen_co_k" id="id_input_nomen_co_k" value="0"/>
Партия<input type=text name="name_input_nomen_co_part" id="id_input_nomen_co_part" value="0"/>
</div>
<!--/div>
</div-->
