...
<input type=button id=new_naryad name=new_naryad value='Новый наряд'  onclick="f_new_naryad()">
<input type=button id=show_total name=show_total value="Итого" onclick="f_show_total()">


<div id=naryad_pane style="width: 100%; height:450px; border: solid red 2px;overflow:scroll;"></div>
<table>
<tr>
<td>Наряд</td><td>Таб.№</td><td>Деталь</td><td>Операция</td><td>Кол-во</td><td>Мин.</td><td>Коп.</td><td>Заказ</td><td>Действие</td>
</tr>
<tr>
<td>
...
<div id=total_pane style="width: 100%; border: solid red 2px;overflow:scroll; display:none"></div>

<script>
function edit_line(td, god, mes, nar, npp){
    id_naryad_pane.disabled= true;
...
function show_spz(button, god, mes, spz){
    id_cur_god.value=god;
    id_cur_mes.value=mes;
    id_cur_tab.disabled=true;
    id_append_record.disabled=true;
...
function show_tab(button, god, mes, tab){
    id_cur_god.value=god;
    id_cur_mes.value=mes;
    id_cur_tab.disabled=true;
    id_append_record.disabled=true;
